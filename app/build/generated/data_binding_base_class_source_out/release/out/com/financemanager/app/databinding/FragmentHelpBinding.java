...
public final class FragmentHelpBinding implements ViewBinding {
  ...
  private FragmentHelpBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView recyclerView,
  ...
  public static FragmentHelpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHelpBinding((LinearLayout) rootView, recyclerView, toolbar);
    }
