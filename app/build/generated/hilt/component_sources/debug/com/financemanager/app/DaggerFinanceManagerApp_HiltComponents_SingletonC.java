...
public final class DaggerFinanceManagerApp_HiltComponents_SingletonC {
  ...
  private static final class FragmentCImpl extends FinanceManagerApp_HiltComponents.FragmentC {
    ...
    private ReceiptOcrHelper receiptOcrHelper() {
      return new ReceiptOcrHelper(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 11: // com.financemanager.app.presentation.recurring.RecurringTransactionViewModel 
          ...
          case 12: // com.financemanager.app.presentation.auth.RegisterViewModel 
          return (T) new RegisterViewModel(viewModelCImpl.registerUseCase(), singletonCImpl.sessionManagerProvider.get());

          case 13: // com.financemanager.app.presentation.reports.ReportsViewModel 
          ...
          case 14: // com.financemanager.app.presentation.settings.SettingsViewModel 
          ...
          case 15: // com.financemanager.app.presentation.splitbill.SplitBillViewModel 
          ...
          case 16: // com.financemanager.app.presentation.transaction.TransactionViewModel 
