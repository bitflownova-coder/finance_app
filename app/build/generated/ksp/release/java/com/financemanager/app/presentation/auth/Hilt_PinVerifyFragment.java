...
public abstract class Hilt_PinVerifyFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PinVerifyFragment() {
    super();
  }

  Hilt_PinVerifyFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PinVerifyFragment_GeneratedInjector) this.generatedComponent()).injectPinVerifyFragment(UnsafeCasts.<PinVerifyFragment>unsafeCast(this));
    }
  }
