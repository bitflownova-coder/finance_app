...
public abstract class Hilt_BudgetFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BudgetFragment_GeneratedInjector) this.generatedComponent()).injectBudgetFragment(UnsafeCasts.<BudgetFragment>unsafeCast(this));
    }
  }
