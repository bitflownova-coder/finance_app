...
public abstract class Hilt_AddSplitBillDialog extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddSplitBillDialog() {
    super();
  }

  Hilt_AddSplitBillDialog(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddSplitBillDialog_GeneratedInjector) this.generatedComponent()).injectAddSplitBillDialog(UnsafeCasts.<AddSplitBillDialog>unsafeCast(this));
    }
  }
