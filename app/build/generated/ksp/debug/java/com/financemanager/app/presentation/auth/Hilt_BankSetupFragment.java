...
public abstract class Hilt_BankSetupFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BankSetupFragment() {
    super();
  }

  Hilt_BankSetupFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BankSetupFragment_GeneratedInjector) this.generatedComponent()).injectBankSetupFragment(UnsafeCasts.<BankSetupFragment>unsafeCast(this));
    }
  }
