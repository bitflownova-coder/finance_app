  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(8) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `split_bills` (`split_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `transaction_id` INTEGER NOT NULL, `user_id` INTEGER NOT NULL, `total_amount` REAL NOT NULL, `description` TEXT NOT NULL, `split_type` TEXT NOT NULL, `created_at` INTEGER NOT NULL, `is_settled` INTEGER NOT NULL, FOREIGN KEY(`transaction_id`) REFERENCES `transactions`(`transaction_id`) ON UPDATE NO ACTION ON DELETE CASCADE , FOREIGN KEY(`user_id`) REFERENCES `users`(`user_id`) ON UPDATE NO ACTION ON DELETE CASCADE )");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '444d0fb2e4a4ceb99dcbabe29245ae43')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsSplitBills.put("transaction_id", new TableInfo.Column("transaction_id", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final HashSet<TableInfo.ForeignKey> _foreignKeysSplitBills = new HashSet<TableInfo.ForeignKey>(2);
        _foreignKeysSplitBills.add(new TableInfo.ForeignKey("transactions", "CASCADE", "NO ACTION", Arrays.asList("transaction_id"), Arrays.asList("transaction_id")));
    ...
    }, "444d0fb2e4a4ceb99dcbabe29245ae43", "2f1a8a54a272987583539d0eaccdeb2f");
