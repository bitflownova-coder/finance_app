...
public abstract class Hilt_TransactionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TransactionFragment() {
    super();
  }

  Hilt_TransactionFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TransactionFragment_GeneratedInjector) this.generatedComponent()).injectTransactionFragment(UnsafeCasts.<TransactionFragment>unsafeCast(this));
    }
  }
