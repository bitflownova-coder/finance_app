...
public abstract class Hilt_InsightsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_InsightsFragment() {
    super();
  }

  Hilt_InsightsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InsightsFragment_GeneratedInjector) this.generatedComponent()).injectInsightsFragment(UnsafeCasts.<InsightsFragment>unsafeCast(this));
    }
  }
