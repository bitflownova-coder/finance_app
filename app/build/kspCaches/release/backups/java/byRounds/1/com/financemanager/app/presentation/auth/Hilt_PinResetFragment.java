...
public abstract class Hilt_PinResetFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PinResetFragment() {
    super();
  }

  Hilt_PinResetFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PinResetFragment_GeneratedInjector) this.generatedComponent()).injectPinResetFragment(UnsafeCasts.<PinResetFragment>unsafeCast(this));
    }
  }
