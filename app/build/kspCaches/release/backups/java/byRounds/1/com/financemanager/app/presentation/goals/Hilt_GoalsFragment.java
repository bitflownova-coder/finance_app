...
public abstract class Hilt_GoalsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GoalsFragment_GeneratedInjector) this.generatedComponent()).injectGoalsFragment(UnsafeCasts.<GoalsFragment>unsafeCast(this));
    }
  }
