...
public abstract class Hilt_AddEditTransactionDialog extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddEditTransactionDialog() {
    super();
  }

  Hilt_AddEditTransactionDialog(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddEditTransactionDialog_GeneratedInjector) this.generatedComponent()).injectAddEditTransactionDialog(UnsafeCasts.<AddEditTransactionDialog>unsafeCast(this));
    }
  }
