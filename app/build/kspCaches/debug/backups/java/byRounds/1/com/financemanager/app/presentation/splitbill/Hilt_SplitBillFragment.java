...
public abstract class Hilt_SplitBillFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SplitBillFragment() {
    super();
  }

  Hilt_SplitBillFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SplitBillFragment_GeneratedInjector) this.generatedComponent()).injectSplitBillFragment(UnsafeCasts.<SplitBillFragment>unsafeCast(this));
    }
  }
