...
public abstract class Hilt_AddEditBudgetDialog extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddEditBudgetDialog() {
    super();
  }

  Hilt_AddEditBudgetDialog(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddEditBudgetDialog_GeneratedInjector) this.generatedComponent()).injectAddEditBudgetDialog(UnsafeCasts.<AddEditBudgetDialog>unsafeCast(this));
    }
  }
