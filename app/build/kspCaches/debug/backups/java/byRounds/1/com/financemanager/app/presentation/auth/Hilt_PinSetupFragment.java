...
public abstract class Hilt_PinSetupFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PinSetupFragment() {
    super();
  }

  Hilt_PinSetupFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PinSetupFragment_GeneratedInjector) this.generatedComponent()).injectPinSetupFragment(UnsafeCasts.<PinSetupFragment>unsafeCast(this));
    }
  }
