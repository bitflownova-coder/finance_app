...
public abstract class Hilt_RecurringTransactionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RecurringTransactionFragment() {
    super();
  }

  Hilt_RecurringTransactionFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecurringTransactionFragment_GeneratedInjector) this.generatedComponent()).injectRecurringTransactionFragment(UnsafeCasts.<RecurringTransactionFragment>unsafeCast(this));
    }
  }
